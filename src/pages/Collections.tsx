                ...
                <SectionReveal key={col.id} delay={i * 0.1}>
                  <div className="bg-background group relative overflow-hidden">
                    ...
                    <div className="p-8">
                      ...
                      <p className="text-muted-foreground text-sm mb-0 max-h-0 opacity-0 group-hover:max-h-24 group-hover:opacity-100 group-hover:mb-4 transition-all duration-700 ease-in-out overflow-hidden leading-relaxed">{col.description}</p>="text-muted-foreground text-sm mb-0 max-h-0 opacity-0 group-hover:max-h-24 group-hover:opacity-100 group-hover:mb-4 transition-all duration-700 ease-in-out overflow-hidden leading-relaxed">{col.description}</p>">{col.description}</p>
                      {col.sizes.length > 0 && (
