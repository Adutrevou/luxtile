                ...
                <SectionReveal key={col.id} delay={i * 0.15}>
                  <Link to="/collections" className="group block relative overflow-hidden aspect-[3/4]">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-8">
                      ...
                      <p className="text-primary-foreground/60 text-sm max-h-0 opacity-0 group-hover:max-h-24 group-hover:opacity-100 <p className="text-primary-foreground/60 text-sm max-h-0 opacity-0 group-hover:max-h-24 group-hover:opacity-100 transition-all duration-700 ease-in-out overflow-hidden">">
                        {col.description}
                      </p>
                    </div>
                  </Link>
